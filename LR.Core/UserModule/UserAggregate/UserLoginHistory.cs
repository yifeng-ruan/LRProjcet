...
{
    public class UserLoginHistory : UserLoginHistoryTB
    {
        /// <summary>
        /// 用户实体
        /// </summary>
        ...
        public override string _ActiveInsertCols
        {
            get
            {
                ...
                {
                    return @"RecentHostName,RecentHostIP,RecentLoginCity,RecentLoginDate,
                                UserName,
HostName,HostIP,LoginCity,LoginDate";
                }
                else
                {
...
HostName,HostIP,LoginCity,LoginDate";
        ...
        public override string _ActiveSelectCols
        {
            get
            {
                ...
                {
                    return @"ID,RecentHostName,RecentHostIP,RecentLoginCity,RecentLoginDate,
                                UserName,
HostName,HostIP,LoginCity,LoginDate";
                }
                else
